    ...
    <?php include('side-pannel.php'); ?>
      ...
      <div class="body-content">
        ...
        <div class="container-fluid">
          <div class="page-head">
            <h4 class="mt-2 mb-2">Add Rooms</h4>
          </div>
          <div class="row">
                            ...
                            <div class="card m-b-30">
                                <div class="card-body">
                                    ...
                                    <div class="general-label">
                                        <form role="form" method="post" action="../Handlers/add_rooms_handler.php">                                            
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-10">
                                                    <input class="form-control" type="number"  name="room_capacity" id="room_capacity" >
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <label for="Room Status" class="col-2 col-form-label">Room Status</label>
                                                <div class="col-10">
                                                <select class="select2 form-control mb-3 custom-select" name="room_status" id="room_status" style="width: 100%; height:36px;">
                                        <option>Select</option>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-10">
                                                <textarea class="form-control" placeholder="Write Description" name="room_description" id="room_description" style="margin-top: 0px; margin-bottom: 0px; height: 137px;"></textarea>
                                                </div>
                                            </div>
