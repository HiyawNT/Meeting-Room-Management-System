        ...
        <div class="">
          <table id="datatable2" class="table">
            ...
            require_once '../config/config.php';
                      ...
                      $stmt = $pdo->prepare("SELECT rr.id, r.name AS room_name, u.username AS user_name, u.email AS user_email, rr.start_date, rr.end_date, rr.duration, rr.start_time, rr.end_time, rr.reason, rr.status 
