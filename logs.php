...
<html lang="en">
  ...
  <body class="sticky-header">
    ...
    <!-- Left side Pannel -->
     <?php include('include/side-pannel.php'); ?>
        ...
        <div class="header-section">
          ...
          <div class="logo">
            <a href="logs.php">
              ...
              <span class="brand-name">History</span>
            </a>
          </div>
                            ...
                            <div class="col-lg-12 col-sm-12">
                                <div class="card m-b-30">
                                    <div class="card-body">
                                        ...
                                        <p class="text-muted">This is an experimental awesome solution for responsive tables with complex data.</p>
                                        <div class="table-rep-plugin">
                                            <div class="table-responsive" data-pattern="priority-columns">
                                                <table id="tech-companies-1" class="table  table-striped">
                                                    ...
                                                    <tbody>
                                                    <tr>
                                                        <th> <span class="co-name">Human Resource</span></th>
                                                        <td>23/01/23</td>
                                                        <td>1</td>
                                                    ...
                                                    <tr>
                                                        <th> <span class="co-name">Finance</span></th>
                                                        <td>23/01/23</td>
                                                        <td>2</td>
                                                    ...
                                                    <tr>
                                                        <th> <span class="co-name">Inventory</span></th>
                                                        <td>23/01/23</td>
                                                        <td>3</td>
                                                        <td class="btn btn-success">Approved</td>
                                                    ...
                                                    <tr>
                                                        <th> <span class="co-name">Labratory</span></th>
                                                        <td>23/01/23</td>
                                                        <td>2</td>
                                                        <td class="btn btn-success">Approved</td>                                                        
                                                    </tr>
