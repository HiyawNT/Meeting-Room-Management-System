                        ...
                        <div class="col-lg-3 col-sm-6 bg-gradient">
                           <div class="widget-box bg-grad-3 m-b-30">
                                <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-4 align-self-end">
                                    <?php
                                  $stmt = $pdo->prepare("SELECT COUNT(*) FROM room_reservation WHERE user_id = ? AND status = 'pending'");
                                  $stmt->execute([$_SESSION['users']['id']]);
                        ...
                        <div class="col-lg-3 col-sm-6 bg-gradient">
                            <div class="widget-box bg-grad-2 m-b-30 ">
                                <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-4 align-self-end">
                                    <?php
                                  $stmt = $pdo->prepare("SELECT COUNT(*) FROM room_reservation WHERE user_id = ? AND status = 'approved'");
                                  $stmt->execute([$_SESSION['users']['id']]);
                        ...
                        <div class="col-lg-3 col-sm-6 bg-gradient">
                            <div class="widget-box bg-grad-3 m-b-30 ">
                                <div class="row d-flex align-items-center">
                                    ...
                                    <div class="col-4 align-items-center">
                                       <p class="m-0 text-white text-center">Request Rejected</p> 
                                    </div>                                    
                                    <div class="col-4 align-self-end">
                                    <?php
                                  $stmt = $pdo->prepare("SELECT COUNT(*) FROM room_reservation WHERE user_id = ? AND status = 'rejected'");
                                  $stmt->execute([$_SESSION['users']['id']]);
                                  $rejected_count = $stmt->fetchColumn();
                                      ?>
                                        <h2 class="m-0 counter text-right"><?php echo $rejected_count; ?></h2></h2>
                                    </div>
                                </div>
                           </div> 
                        </div>
