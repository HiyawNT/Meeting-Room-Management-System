                                ...
                                <div class="account-box">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            ...
                                            <form class="form mt-5 contact-form" method="post" action="./Handlers/user_registration_handler.php">
                                            <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    <div class="col-sm-12 mt-4">
                                                        <button class="btn btn-primary btn-block" name="submit" type="submit">Register User</button>
                                                    </div>
                                                </div>
